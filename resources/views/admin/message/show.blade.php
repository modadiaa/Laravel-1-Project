        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-3">
                        <a href="{{ route('dashboard.messages.destroy', ['id' => $data->id]) }}"
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">{{ __('words.show-messages') }}</li>
        ...
        <section class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"> {{ __('words.show-messages') }}</h3>
                </div>
                <!-- /.card-header -->
