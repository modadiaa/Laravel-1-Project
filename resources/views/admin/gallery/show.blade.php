...
@section('title', 'Show Gallery :' . $data->title)
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-3">
                        <a href="{{ route('dashboard.gallery.edit', ['id' => $data->id]) }}"
                            class="btn btn-block bg-gradient-info" style="width: 200px">{{ __('words.edit') }}</a>
                    </div>
                    <div class="col-sm-3">
                        <a href="{{ route('dashboard.gallery.destroy', ['id' => $data->id]) }}"
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">{{ __('words.show-gallery') }}</li>
        ...
        <section class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"> {{ __('words.show-gallery') }}</h3>
                </div>
                <!-- /.card-header -->
